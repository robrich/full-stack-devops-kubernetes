  ...
  return (
    <div className="app-container">
      <header className="app-header">
        ...
        <h1 className="app-title">Techorama Full Stack DevOps Demo</h1>
      ...
      <footer className="app-footer">
        <nav aria-label="Footer navigation">
          <a href="https://techorama.be" target="_blank" rel="noopener noreferrer">
            Learn more about Techorama<span className="visually-hidden"> (opens in new tab)</span>
          </a>
          <a
            ...
            aria-label="View Full Stack DevOps by robrich on GitHub (opens in new tab)"
          >
