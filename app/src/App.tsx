  ...
  return (
    <div className="app-container">
      <header className="app-header">
        <a
          href="https://prairiedevcon.com"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Visit Prairie Dev Con website (opens in new tab)"
          className="logo-link"
        >
          <img src={aspireLogo} className="logo" alt="Aspire logo" />
        </a>
        <h1 className="app-title">Hello Prairie Dev Con</h1>
      ...
      <footer className="app-footer">
        <nav aria-label="Footer navigation">
          <a href="https://prairiedevcon.com" target="_blank" rel="noopener noreferrer">
            Learn more about Prairie Dev Con<span className="visually-hidden"> (opens in new tab)</span>
          </a>
          <a
            ...
            aria-label="View Full Stack DevOps on GitHub (opens in new tab)"
          >
