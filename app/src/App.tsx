  ...
  return (
    <div className="app-container">
      <header className="app-header">
        <a
          href="https://www.meetup.com/utah-kubernetes-meetup/events/313345221"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Visit Utah Kubernetes Meetup website (opens in new tab)"
          className="logo-link"
        >
          <img src={aspireLogo} className="logo" alt="Aspire logo" />
        </a>
        <h1 className="app-title">Utah Kubernetes</h1>
      ...
      <footer className="app-footer">
        <nav aria-label="Footer navigation">
          <a href="https://www.meetup.com/utah-kubernetes-meetup/events/313345221" target="_blank" rel="noopener noreferrer">
            Learn more about Utah Kubernetes<span className="visually-hidden"> (opens in new tab)</span>
          </a>
          <a
            href="https://github.com/robrich/full-stack-devops-kubernetes"
            target="_blank"
            rel="noopener noreferrer"
            className="github-link"
            aria-label="View Full Stack DevOps Kubernetes on GitHub (opens in new tab)"
          >
